...
# In the following example, two kinds of information are stored for each pizza: a type of 
# crust and a list of toppings. The list of toppings is a value associated with the key
# 'toppings'. To use the items in the list, we give the name of the dictionary and the key
# 'toppings', as we would any value in the dictionary. Instead of returning a single value,
